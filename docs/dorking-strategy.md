...
## ATS Lookup Integration

The [ATS Lookup](/companies-search) feature works alongside the Dork Builder to give you a complete picture:

1. **Find the ATS** — Search any company in the ATS Lookup to see which platform they use (Greenhouse, Ashby, Lever, etc.)
2. **Click through** — One click takes you directly to that company's job board
3. **Build a dork** — Use the Dork Builder to target specific roles at that company, across their ATS domain

This two-step workflow means you never need to guess which ATS a company uses. The data covers 115,000+ companies across 25+ platforms, including all major ATS systems.
