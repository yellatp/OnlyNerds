 ...
 * Some BambooHR instances use /careers/ID while others use /careers/view/ID.
 * The API returns /careers/view/ID but certain companies need /careers/ID.
 * Map of company slugs that need the alternate format (without /view/).
 */
const BAMBOO_ALT_FORMAT = new Set([
    '31greenltd',
]);
