...
import { buildTargetedUrl, getLevelQuery } from '../../lib/dorkUtils';
import RoleTargeter from '../shared/RoleTargeter';
...
export default function VCDirectory({ firms }: Props) {
  ...
  const selectedLevelQuery = getLevelQuery(targetLevel);
